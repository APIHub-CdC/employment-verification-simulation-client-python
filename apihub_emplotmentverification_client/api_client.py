...
import apihub_emplotmentverification_client.models
from apihub_emplotmentverification_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(apihub_emplotmentverification_client.models, klass)
